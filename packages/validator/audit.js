...
import { validateResolvedAppearance } from '@paper-rig/appearance';
...
export function auditRig(rig, options = {}) {
  ...
  const diagnostics = [
    ...
    ...validateResolvedAppearance(rig).checks.map((check) => diagnostic(
      `appearance.${check.id}`,
      check.pass,
      check.detail,
      'error',
...
.paperPlate{fill:#d7c39c;stroke:#39362e;stroke-width:1.2;vector-effect:non-scaling-stroke}.plateShade{fill:#b99d73}.paperPlate[data-palette-role="shadow"]{fill:#9d927d}.coreOccluderCell,.jointGasket{fill:#d7c39c;stroke:#d7c39c;stroke-width:1.5;vector-effect:non-scaling-stroke}.faceEye{fill:#fffdf7;stroke:#39362e;stroke-width:.8}.faceNose,.wingMembrane{fill:#b99d73;stroke:#39362e;stroke-width:.8;stroke-linejoin:round}.paperPaint{fill:#eadbb9;stroke:none}.boneLine{stroke:#567084;stroke-width:.35}.jointDot{fill:#fff;stroke:#567084;stroke-width:.25}.labelText{fill:#28231d;font-size:2px}.contactRing{fill:none;stroke:#5d8e62;stroke-width:.55}
